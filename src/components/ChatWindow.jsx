...
function ChatWindow({ conversation, onSendMessage, onLoadMoreMessages, socket, conversations, onSelectConversation, loadingConversation = false, labels = [], onManageLabels, onLabelChange, onToggleOnHold }) {
  // ==================== DEBUG CRÍTICO ====================
    ...
    <div className="chat-window">
      <div className="chat-header">
        ...
        <div className="chat-header-actions">
          ...
          />
          <button
            className={`icon-button on-hold-button ${conversation.onHold ? 'on-hold' : ''}`}
            onClick={() => onToggleOnHold?.(conversation.userId, !conversation.onHold)}
            title={conversation.onHold ? 'Remover de espera' : 'Colocar em espera'}
          >
            {conversation.onHold ? (
              <svg viewBox="0 0 24 24" width="24" height="24">
